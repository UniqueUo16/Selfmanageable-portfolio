...
export default function Whatsapp() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-[#1c1c1c] via-[#2e2e2e] to-[#4a4a4a] text-white">
      <div className="text-center mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-wide mb-2">
          Connect With Me On WhatsApp
        </h1>
        <p className="text-gray-300 text-sm sm:text-base">
          Scan the QR code below or click the button to start chatting directly.
        </p>
      </div>

      <div className="flex justify-center items-center bg-white/10 backdrop-blur-lg p-6 rounded-2xl shadow-lg">
        <Image
          src="/imgs/watsapp-conn.JPG"
          alt="WhatsApp QR"
          width={400}
          height={400}
