...
function ServiceCard({ icon, image, title, description, button }) {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-xl transition-all duration-300 hover:bg-gray-200 hover:text-[#8d2c8d] flex flex-col items-start">
      ...
      <Link href="/Ex_pages/fContactme" className="bg-[#be3bbe] font-bold text-white active:text-black active:bg-white hover:text-black hover:bg-white p-2 mt-[1rem] rounded-sm w-full">
        {button}
      </Link>
    </div>
  );
        ...
        <ServiceCard
          ...
          image={
            <Image
              ...
              height={100}
              width={500}
              className="rounded-sm h-[50vh] sm:rounded-sm sm:h-[14rem] sm:w-[17.2rem] sm:ml-[-1.3rem]"
            />
          }
        ...
        <ServiceCard
          ...
          image={
            <Image
              ...
              height={100}
              width={500}
              className=" rounded-sm h-[40vh] sm:rounded-sm sm:h-[14rem] sm:w-[17.2rem] sm:ml-[-1.3rem]"
            />
          }
        ...
        <ServiceCard
          ...
          image={
            <Image
              ...
              height={100}
              width={500}
              className="rounded-lg h-[40vh] sm:rounded-sm sm:h-[14rem] sm:w-[17.2rem] sm:ml-[-1.3rem]"
            />
          }
